  ...
  extends FrameLayout
{
  ...
  {
    if ((this.mPersistFocusVertical) && ((paramInt == 33) || (paramInt == 130))) {}
    while ((!this.mPersistFocusVertical) && ((paramInt == 17) || (paramInt == 66))) {
      return true;
    }
    return false;
  }
  ...
  public void addFocusables(ArrayList<View> paramArrayList, int paramInt1, int paramInt2)
  {
    ...
    while (!shouldPersistFocusFromDirection(paramInt1))
    {
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v17\leanback\widget\PersistentFocusWrapper.class
