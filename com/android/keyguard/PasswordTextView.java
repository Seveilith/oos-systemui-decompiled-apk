  ...
  extends View
{
  ...
  public PasswordTextView(Context paramContext, AttributeSet paramAttributeSet, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        this.mGravity = paramContext.getInt(R.styleable.PasswordTextView_android_gravity, 17);
        this.mDotSize = paramContext.getDimensionPixelSize(R.styleable.PasswordTextView_dotSize, getContext().getResources().getDimensionPixelSize(R.dimen.password_dot_size));
        this.mCharPadding = paramContext.getDimensionPixelSize(R.styleable.PasswordTextView_charPadding, getContext().getResources().getDimensionPixelSize(R.dimen.password_char_padding));
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    if ((this.mGravity & 0x7) == 3) {
      if (((this.mGravity & 0x800000) != 0) && (getLayoutDirection() == 1)) {
        f1 = getWidth() - getPaddingRight() - f1;
      }
    }
    for (;;)
    {
      ...
      int m = localRect.top;
      float f2 = (getHeight() - getPaddingBottom() - getPaddingTop()) / 2 + getPaddingTop();
      paramCanvas.clipRect(getPaddingLeft(), getPaddingTop(), getWidth() - getPaddingRight(), getHeight() - getPaddingBottom());
  ...
  public void onInitializeAccessibilityEvent(AccessibilityEvent paramAccessibilityEvent)
  {
    ...
    paramAccessibilityEvent.setClassName(PasswordTextView.class.getName());
  ...
  public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo paramAccessibilityNodeInfo)
  {
    ...
    paramAccessibilityNodeInfo.setClassName(PasswordTextView.class.getName());
  ...
  private class CharState
  {
    ...
    Animator.AnimatorListener dotFinishListener = new AnimatorListenerAdapter()
    {
      ...
      {
        PasswordTextView.CharState.this.dotAnimator = null;
      }
    };
    private ValueAnimator.AnimatorUpdateListener dotSizeUpdater = new ValueAnimator.AnimatorUpdateListener()
    {
      ...
      {
        PasswordTextView.CharState.this.currentDotSizeFactor = ((Float)paramAnonymousValueAnimator.getAnimatedValue()).floatValue();
    ...
    private Runnable dotSwapperRunnable = new Runnable()
    {
      public void run()
      {
        PasswordTextView.CharState.-wrap1(PasswordTextView.CharState.this);
        PasswordTextView.CharState.this.isDotSwapPending = false;
      }
    };
    ...
    Animator.AnimatorListener removeEndListener = new AnimatorListenerAdapter()
    {
      ...
      public void onAnimationEnd(Animator paramAnonymousAnimator)
      {
        if (!this.mCancelled)
        {
          PasswordTextView.-get7(PasswordTextView.this).remove(PasswordTextView.CharState.this);
          PasswordTextView.-get2(PasswordTextView.this).push(PasswordTextView.CharState.this);
          PasswordTextView.CharState.this.reset();
          PasswordTextView.CharState.-wrap0(PasswordTextView.CharState.this, PasswordTextView.CharState.this.textTranslateAnimator);
          PasswordTextView.CharState.this.textTranslateAnimator = null;
        }
      }
    ...
    Animator.AnimatorListener textFinishListener = new AnimatorListenerAdapter()
    {
      public void onAnimationEnd(Animator paramAnonymousAnimator)
      {
        PasswordTextView.CharState.this.textAnimator = null;
      }
    };
    private ValueAnimator.AnimatorUpdateListener textSizeUpdater = new ValueAnimator.AnimatorUpdateListener()
    {
      public void onAnimationUpdate(ValueAnimator paramAnonymousValueAnimator)
      {
        PasswordTextView.CharState.this.currentTextSizeFactor = ((Float)paramAnonymousValueAnimator.getAnimatedValue()).floatValue();
        PasswordTextView.this.invalidate();
      }
    };
    ...
    private ValueAnimator.AnimatorUpdateListener textTranslationUpdater = new ValueAnimator.AnimatorUpdateListener()
    {
      public void onAnimationUpdate(ValueAnimator paramAnonymousValueAnimator)
      {
        PasswordTextView.CharState.this.currentTextTranslationY = ((Float)paramAnonymousValueAnimator.getAnimatedValue()).floatValue();
        PasswordTextView.this.invalidate();
      }
    };
    char whichChar;
    ...
    Animator.AnimatorListener widthFinishListener = new AnimatorListenerAdapter()
    {
      public void onAnimationEnd(Animator paramAnonymousAnimator)
      {
        PasswordTextView.CharState.this.widthAnimator = null;
      }
    };
    private ValueAnimator.AnimatorUpdateListener widthUpdater = new ValueAnimator.AnimatorUpdateListener()
    {
      public void onAnimationUpdate(ValueAnimator paramAnonymousValueAnimator)
      {
        PasswordTextView.CharState.this.currentWidthFactor = ((Float)paramAnonymousValueAnimator.getAnimatedValue()).floatValue();
        PasswordTextView.this.invalidate();
      }
    };
    ...
    private void postDotSwap(long paramLong)
    {
      ...
      PasswordTextView.this.postDelayed(this.dotSwapperRunnable, paramLong);
    ...
    private void startDotAppearAnimation(long paramLong)
    {
      ...
      if (!PasswordTextView.-get6(PasswordTextView.this))
      {
        ...
        localValueAnimator1.setInterpolator(PasswordTextView.-get0(PasswordTextView.this));
    ...
    private void startDotDisappearAnimation(long paramLong)
    {
      ...
      localValueAnimator.setInterpolator(PasswordTextView.-get3(PasswordTextView.this));
    ...
    private void startTextAppearAnimation()
    {
      ...
      this.textAnimator.setInterpolator(PasswordTextView.-get0(PasswordTextView.this));
      ...
      if (this.textTranslateAnimator == null)
      {
        ...
        this.textTranslateAnimator.setInterpolator(PasswordTextView.-get0(PasswordTextView.this));
    ...
    private void startTextDisappearAnimation(long paramLong)
    {
      ...
      this.textAnimator.addUpdateListener(this.textSizeUpdater);
      this.textAnimator.addListener(this.textFinishListener);
      this.textAnimator.setInterpolator(PasswordTextView.-get3(PasswordTextView.this));
    ...
    public float draw(Canvas paramCanvas, float paramFloat1, int paramInt, float paramFloat2, float paramFloat3)
    {
      ...
      for (int j = 1;; j = 0)
      {
        ...
        if (i != 0)
        {
          ...
          paramCanvas.drawText(Character.toString(this.whichChar), 0.0F, 0.0F, PasswordTextView.-get5(PasswordTextView.this));
          paramCanvas.restore();
        }
        if (j != 0)
        {
          ...
          paramCanvas.drawCircle(0.0F, 0.0F, PasswordTextView.-get4(PasswordTextView.this) / 2 * this.currentDotSizeFactor, PasswordTextView.-get5(PasswordTextView.this));
          paramCanvas.restore();
        }
        return PasswordTextView.-get1(PasswordTextView.this) * this.currentWidthFactor + paramFloat3;
        i = 0;
        break;
      }
    }
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\com\android\keyguard\PasswordTextView.class
