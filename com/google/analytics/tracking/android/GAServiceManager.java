  ...
  extends ServiceManager
{
  ...
  void onRadioPowered()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 60	com/google/analytics/tracking/android/GAServiceManager:storeIsEmpty	Z
    //   6: istore_1
    //   7: iload_1
    //   8: ifeq +6 -> 14
    //   11: aload_0
    ...
    //   13: return
    //   14: aload_0
    //   15: getfield 51	com/google/analytics/tracking/android/GAServiceManager:connected	Z
    //   18: ifeq -7 -> 11
    //   21: aload_0
    //   22: getfield 47	com/google/analytics/tracking/android/GAServiceManager:dispatchPeriodInSeconds	I
    //   25: ifle -14 -> 11
    //   28: aload_0
    //   29: getfield 82	com/google/analytics/tracking/android/GAServiceManager:handler	Landroid/os/Handler;
    //   32: iconst_1
    //   33: getstatic 43	com/google/analytics/tracking/android/GAServiceManager:MSG_OBJECT	Ljava/lang/Object;
    //   36: invokevirtual 202	android/os/Handler:removeMessages	(ILjava/lang/Object;)V
    //   39: aload_0
    //   40: getfield 82	com/google/analytics/tracking/android/GAServiceManager:handler	Landroid/os/Handler;
    //   43: aload_0
    //   44: getfield 82	com/google/analytics/tracking/android/GAServiceManager:handler	Landroid/os/Handler;
    //   47: iconst_1
    //   48: getstatic 43	com/google/analytics/tracking/android/GAServiceManager:MSG_OBJECT	Ljava/lang/Object;
    //   51: invokevirtual 107	android/os/Handler:obtainMessage	(ILjava/lang/Object;)Landroid/os/Message;
    //   54: invokevirtual 206	android/os/Handler:sendMessage	(Landroid/os/Message;)Z
    //   57: pop
    //   58: goto -47 -> 11
    //   61: astore_2
    //   62: aload_0
  ...
  void overrideHostUrl(String paramString)
  {
    ...
    //   6: ifnull +21 -> 27
    //   9: aload_0
    //   10: getfield 64	com/google/analytics/tracking/android/GAServiceManager:store	Lcom/google/analytics/tracking/android/AnalyticsStore;
    ...
    //   27: aload_0
    //   28: aload_1
    //   29: putfield 165	com/google/analytics/tracking/android/GAServiceManager:pendingHostOverride	Ljava/lang/String;
    //   32: goto -8 -> 24
    //   35: astore_1
    //   36: aload_0
    //   37: monitorexit
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\com\google\analytics\tracking\android\GAServiceManager.class
